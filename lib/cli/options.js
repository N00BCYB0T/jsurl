...
export const options = {
    ...
    host: {
        flags: ['-u', '--url'],
        description: 'Target URL (http://, https://, ws://, wss://)',
        required: true,
        type: 'string',
        category: 'request',
    },
    ...
    wsSend: {
        flags: ['-m', '--message'],
        description: 'WebSocket message to send (can be used multiple times)',
        default: [],
        type: 'array',
        multiple: true,
        category: 'websocket',
    ...
    wsListen: {
        flags: ['-l', '--listen'],
        description: 'Listen time in ms (0 = until close)',
        default: 2000,
        type: 'number',
        category: 'websocket',
    },
    ...
    wsRaw: {
        flags: ['-r', '--raw'],
        description: 'Raw output (no prefixes, messages only)',
        default: false,
        type: 'boolean',
        category: 'websocket',
    },
