...
`;
    ...
    for (const [catKey, cat] of Object.entries(categories)) {
        ...
        for (const opt of cat.items) {
            ...
            help += `    ${c.green}${flags.padEnd(22)}${c.reset} ${opt.description}${defaultVal}${required}\n`;
        }
    }
